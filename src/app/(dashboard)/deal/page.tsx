    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-[#E5E7EB] p-6">
        <div className="flex items-center justify-between mb-5">
          <div>
            <h2 className="text-lg font-semibold text-[#16325C]">{t('overview')}</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-6">
          <div className="space-y-4">
            <div>
              ...
              <p className="text-xl font-bold text-[#16325C] mt-0.5">
                {formatCurrency(deal.totalRTR)}
              </p>
            </div>
            <div>
              <p className="text-xs font-medium text-[#6B7280] uppercase tracking-wide">
              ...
              <p className="text-xl font-bold text-[#16325C] mt-0.5">
                {formatCurrency(deal.balanceRTR)}
              </p>
            </div>
            <div>
              <p className="text-xs font-medium text-[#6B7280] uppercase tracking-wide">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-lg font-semibold text-[#16325C] mt-0.5">
        ...
        <div className="border-t border-[#E5E7EB] pt-5">
          <div className="flex items-center justify-between mb-2">
            <p className="text-sm font-semibold text-[#16325C]">{t('repaymentProgress')}</p>
          ...
          <div className="flex justify-between mt-2 text-xs text-[#6B7280]">
            <span>{t('paid', { amount: formatCurrency(deal.totalRTR - deal.balanceRTR) })}</span>
            <span>{t('total', { amount: formatCurrency(deal.totalRTR) })}</span>
          </div>
        </div>
        ...
        <div className="mt-5 flex items-center gap-2 bg-[#F5F7FA] rounded-xl p-4 border border-[#E5E7EB]">
          ...
          <div>
            <p className="text-xs text-[#6B7280]">{t('expectedFinalDate')}</p>
            <p className="text-sm font-semibold text-[#16325C]">
              {formatDate(deal.expectedFinalDate)}
            </p>
          </div>
        </div>
      </div>
      ...
      {/* Payment Schedule */}
      <div className="bg-white rounded-xl shadow-sm border border-[#E5E7EB] p-6">
        <h2 className="text-base font-semibold text-[#16325C] mb-4">{t('upcomingSchedule')}</h2>
